...
const char* ssid ="Pondok Lestari";
const char* password ="lestari12345";

#define API_KEY "AIzaSyAd2HCcKJV6v9E6JSApoIwG3gv8-vUPDKA"

// ENter Authorized Email and Password
#define USER_EMAIL "kartikaadelia5@gmailcom"
#define USER_PASSWORD "Tikaadelia5"

// Enter Firebase storage bucket ID
#define STORAGE_BUCKET_ID "suhu-dan-cam.appspot.com"
